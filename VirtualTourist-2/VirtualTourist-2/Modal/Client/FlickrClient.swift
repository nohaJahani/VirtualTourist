...
class FlickrClient :NSObject{
    ...
    func taskForGETMethod(_ method: String, parameters: [String:AnyObject], completionHandlerForGET: @escaping (_ result: AnyObject?, _ error: NSError?) -> Void) -> URLSessionDataTask {
        ...
        let request = NSMutableURLRequest(url: filckrURLFromParameters(parameterWithKey, withPathExtension: method))
    ...
    private func filckrURLFromParameters(_ parameters: [String:AnyObject], withPathExtension: String? = nil) -> URL {
